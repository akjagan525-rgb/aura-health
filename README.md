...
- Curated NHS/WHO reading links, care guidance, optional non-identifying symptom context, “what to monitor,” clinician discussion prompts, English/Tamil interface, optional voice input/read-aloud, copy/print/private text export, feedback, contact form, privacy notice, terms, and installable/offline-safe app pages.
